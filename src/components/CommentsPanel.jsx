...
export default function CommentsPanel({ videoId, currentUser, onCountChange, onClose }) {
  ...
  return (
    <>
      ...
      {/* Backdrop — z-index 4000 covers EVERYTHING including nav (1000) and icons (10) */}
      <div style={{
      ...
      {/* Panel — z-index 4001, sits above backdrop */}
      <div style={{
        position: "fixed",
        ...
        {/* Input */}
        <div style={{ flexShrink:0, background:T.bg1, borderTop:`1px solid ${T.border}`, padding:"12px 16px", paddingBottom: keyboardH>0 ? "12px" : "calc(16px + env(safe-area-inset-bottom,0px))" }}>
