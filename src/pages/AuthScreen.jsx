...
export default function AuthScreen() {
  ...
  if (mode === "landing") return (
    <div style={S.page}>
      ...
      {/* ← "Free forever. No credit card." line removed */}
    </div>
  );
  ...
  if (mode === "login") return (
    <div style={S.page}>
      ...
      <div style={{ ...S.or, maxWidth:"340px", margin:"16px 0 12px" }}><div style={S.line}/><span style={S.ort}>or</span><div style={S.line}/></div>
...
function SocBtn({ label, icon, onClick, loading, primary }) {
  return (
    <button onClick={onClick} disabled={loading} style={{ width:"100%", background:primary?T.gradPrimary:T.bg2, border:primary?"none":`1px solid ${T.border}`, borderRadius:"14px", padding:"14px 20px", fontSize:"16px", fontWeight:"600", fontFamily:T.fontBody, color:T.white, cursor:loading?"not-allowed":"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:"10px", opacity:loading?0.6:1 }}>
...
const S = {
  ...
  glow:       { position:"absolute", top:"20%", left:"50%", transform:"translate(-50%,-50%)", width:"400px", height:"400px", borderRadius:"50%", background:"radial-gradient(circle,rgba(255,45,85,0.07) 0%,transparent 65%)", pointerEvents:"none" },
