...
const S = {
  ...
  logo:{fontFamily:"sans-serif",fontSize:"26px",fontWeight:"700",color:"#f5f0e8"},
  notif:{fontSize:"22px",cursor:"pointer"},
  tabs:{display:"flex",padding:"0 20px",borderBottom:"1px solid #222",marginBottom:"8px"},
  tab:{padding:"10px 16px",fontSize:"14px",fontWeight:"500",cursor:"pointer",transition:"all 0.2s"},
  ...
  empty:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"60vh",gap:"12px",padding:"20px"},
  emptyIcon:{fontSize:"48px"},
  emptyTitle:{color:"#666",fontSize:"18px",fontWeight:"600"},
  ...
  video:{width:"100%",maxHeight:"400px",display:"block",objectFit:"contain",background:"#000"},
  videoOverlay:{position:"absolute",top:"12px",left:"12px"},
  tag:{background:"#ff5c1a",color:"#fff",fontSize:"11px",fontWeight:"700",padding:"4px 10px",borderRadius:"6px",fontFamily:"monospace",letterSpacing:"0.05em"},
  actions:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px"},
  actionLeft:{display:"flex",alignItems:"center",gap:"10px"},
  avatar:{width:"36px",height:"36px",borderRadius:"50%",background:"#2a2a2a",border:"1px solid #444",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",fontWeight:"600",color:"#f5f0e8",flexShrink:0},
  username:{fontSize:"14px",fontWeight:"500",color:"#f5f0e8"},
  timestamp:{fontSize:"11px",color:"#555",fontFamily:"monospace"},
  actionRight:{display:"flex",gap:"4px"},
  actionBtn:{background:"none",border:"none",color:"#888",fontSize:"13px",cursor:"pointer",padding:"6px 8px",borderRadius:"8px"},
  commentWrap:{display:"flex",gap:"8px",padding:"0 16px 12px"},
  commentInput:{flex:1,background:"#222",border:"1px solid #333",borderRadius:"20px",padding:"8px 14px",color:"#f5f0e8",fontSize:"13px",outline:"none"},
  commentBtn:{background:"#d4ff00",border:"none",borderRadius:"20px",padding:"8px 16px",fontSize:"13px",fontWeight:"600",color:"#000",cursor:"pointer"},
  verdictWrap:{margin:"0 16px 12px",background:"#222",borderRadius:"12px",padding:"14px"},
  verdictTitle:{fontSize:"13px",color:"#888",marginBottom:"10px",textAlign:"center"},
  verdictBtns:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"},
  approveBtn:{background:"#00e676",border:"none",borderRadius:"8px",padding:"12px",fontSize:"14px",fontWeight:"700",color:"#000",cursor:"pointer"},
  disputeBtn:{background:"transparent",border:"1px solid #ff4444",borderRadius:"8px",padding:"12px",fontSize:"14px",fontWeight:"700",color:"#ff4444",cursor:"pointer"},
  approvedMsg:{margin:"0 16px 12px",background:"rgba(0,230,118,0.1)",border:"1px solid rgba(0,230,118,0.3)",borderRadius:"8px",padding:"10px",fontSize:"12px",color:"#00e676",textAlign:"center"},
  disputedMsg:{margin:"0 16px 12px",background:"rgba(255,68,68,0.1)",border:"1px solid rgba(255,68,68,0.3)",borderRadius:"8px",padding:"10px",fontSize:"12px",color:"#ff4444",textAlign:"center"},
  rematchWrap:{padding:"0 16px 14px"},
  rematchBtn:{width:"100%",background:"transparent",border:"1px solid #333",borderRadius:"10px",padding:"10px",fontSize:"13px",color:"#888",cursor:"pointer"},
};